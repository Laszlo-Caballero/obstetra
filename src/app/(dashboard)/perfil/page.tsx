      ...
      <main className="p-5 flex flex-col gap-y-4">
        ...
        <div className="flex items-center gap-x-2">
          <span className="flex items-center gap-x-2">
            ...
            <p className="text-ob-gray-2 text-sm font-medium">Inicio</p>
          </span>
          <IoIosArrowForward className="text-ob-gray-2" size={16} />
          <span className="flex items-center gap-x-2">
            <GoGear className=" text-ob-gray-2" size={16} />
            <p className="text-ob-gray-2 text-sm font-medium">Admin</p>
          </span>
          <IoIosArrowForward className="text-ob-gray-2" size={16} />
          <span className="flex items-center gap-x-2">
            <p className="text-ob-white text-sm font-medium">Perfil</p>
          </span>
        </div>
            ...
            <div className="flex flex-col ">
              ...
              <div className="flex items-center gap-x-2 mt-2">
                <Button
                  ...
                  className={{
                    button: "bg-ob-blue-2",
                    text: "text-ob-lightblue font-medium",
                  }}
                />
                <button className="flex items-center gap-x-2 px-3 py-2.5 border border-ob-gray rounded-md ">
