    ...
    <Modal onClose={onClose}>
      ...
      <form onSubmit={handleSubmit(mutate)}>
        <ModalContent>
          ...
          <div
            {...divProps}
            className="w-full p-[26px] cursor-pointer bg-ob-blue-3 border-2 flex text-white flex-col items-center justify-center gap-y-2.5 border-ob-gray-4 min-h-[132px] rounded-xl"
          >
            ...
            columns={[
              {
                ...
                cell({ row }) {
                  return (
                    <span className="text-ob-white text-xs flex items-center gap-x-1">
                      <LuFile />
                      {row.name}
                    </span>
                  );
